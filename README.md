![docker image](https://github.com/d-demuth/nomad/actions/workflows/docker-publish.yml/badge.svg)
...
2. Clone the repository or download the repository as a zip file.
    ...
    ```sh
    git clone https://github.com/d-demuth/nomad.git
    cd nomad
    ```
    ...
    ```sh
    curl-L -o nomad.zip "https://github.com/d-demuth/nomad/archive/main.zip"
    unzip nomad.zip
    cd nomad
    ```
...
your `docker-compose.yaml` with `ghcr.io/d-demuth/nomad:main` for the services
...
```sh
docker pull ghcr.io/d-demuth/nomad/jupyter:main
```
...
_I get an_ `Error response from daemon: Head "https://ghcr.io/v2/d-demuth/nomad/manifests/main": unauthorized`
